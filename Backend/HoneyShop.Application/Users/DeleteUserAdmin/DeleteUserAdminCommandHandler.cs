...
public class DeleteUserAdminCommandHandler : ICommandHandler<DeleteUserAdminCommand, bool>
{
    private readonly IUserService _userService;
    private readonly ILogger<DeleteUserAdminCommandHandler> _logger;
    private readonly IHttpContextService _httpContextService;

    public DeleteUserAdminCommandHandler(IUserService userService, ILogger<DeleteUserAdminCommandHandler> logger, IHttpContextService httpContextService)
    {
